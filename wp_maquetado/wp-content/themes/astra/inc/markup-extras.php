	...
	if ( ! apply_filters( 'astra_disable_site_identity', false ) ) {
              ...
              <g id="group_6" data-name="group 6" transform="translate(-85.29 -22.91)">
                <g id="logo" transform="translate(-1319.317 -750.643)">
                  ...
                  <g id="arrow" transform="translate(1601.999 776.536) rotate(90)">
                    <rect id="rectangle_10" data-name="rectangle 10" width="12.366" height="12.366" transform="translate(3.191)" fill="#c23f81"/>
                    <rect id="rectangle_11" data-name="rectangle 11" width="12.765" height="12.765" transform="translate(0 2.792)" fill="#fff"/>
                  </g>
                </g>
              </g>
          </svg>
        ...
        <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
          <svg xmlns="http://www.w3.org/2000/svg" width="30" height="25" viewBox="0 0 30 25">
              <g id="group_7" data-name="group 7" transform="translate(-323 -12)">
